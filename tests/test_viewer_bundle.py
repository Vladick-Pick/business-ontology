...
class ViewerBundleTests(unittest.TestCase):
    ...
    def test_show_model_skill_requires_official_publish_and_fallback_reason(self):
        ...
        self.assertIn("viewer_reachability.py", skill)
        self.assertIn("awaiting-owner", skill)
        self.assertIn("does not count as owner", skill)
        self.assertIn("Do not copy the same URL again", skill)
