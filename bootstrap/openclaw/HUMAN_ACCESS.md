...
The accepted model is a company asset. It must live in a user-owned GitHub
repository or company-owned GitHub repository, not in an agent-provider account.
...
|---|---|---|---|---|
| Accepted model | Human or company | User-owned GitHub repository | Ontology cards, source map, decisions, drift, review history, open questions | Agent memory, connector cursors, raw transcripts, private messages, secrets |
| Agent workspace | Agent runtime owner | OpenClaw or local runtime workspace | `AGENTS.md`, `SOUL.md`, `TOOLS.md`, queues, state, traces, digests | Canonical accepted model ownership |
